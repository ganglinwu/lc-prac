...
The deck ships 105 drills across 32 topics (hashmap, two-pointers,
sliding-window, binary-search, strings, sorting, stack, deque, heap,
linked-list, trees, trie, lca, graphs, scc, union-find, topological-sort,
shortest-path, matrix, intervals, prefix-sum, fenwick, segment-tree, dp,
bitmask-dp, greedy, backtracking, bit-manipulation, math, concurrency, design,
complexity), 31 of which are machine-graded code
...
binary lifting, strongly connected components).
