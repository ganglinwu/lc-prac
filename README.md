...
The deck ships 141 drills across 44 topics (hashmap, two-pointers,
...
matrix, matrix-exponentiation, geometry, intervals, prefix-sum, fenwick,
segment-tree, dp, bitmask-dp, digit-dp, greedy, backtracking,
meet-in-the-middle, bit-manipulation, math, number-theory, game-theory,
concurrency, design, complexity), 43 of which are machine-graded
...
function, matrix exponentiation, rerooting a tree DP, convex hulls, digit DP,
Grundy values, meet in the middle).
